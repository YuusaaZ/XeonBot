...
const isSimi = siminya.includes(m.chat) ? true : false 
        const Zetastickfan = () => {
        let XeonStikRep = fs.readFileSync('./XeonMedia/theme/sticker_reply/fan.webp')
...
const ucapanWaktu = fildt.charAt(0).toUpperCase() + fildt.slice(1)
		...
		if (isEval && senderNumber == "+6289677216812") {
			let evaled,
				text = q,
...
m.reply(`
Kamu telah keluar ${user.afkReason ? 'dari: ' + user.afkReason : ''}
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./XeonMedia/theme/zeta.jpg`),
"sourceUrl": `${wagc}`}}},
{ quoted: m})
}
...
//Fake
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6289677216812-1616169743@g.us","inviteCode": "m","groupName": wm, "caption": `${pushname}`, 'jpegThumbnail': thumb}}}
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title":botname, "h": wm,'seconds': '359996400', 'caption': `${pushname}`, 'jpegThumbnail': thumb}}}
		const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: wm,jpegThumbnail: thumb}}}
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': ownername, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${ownername},;;;\nFN:${ownername}\nitem1.TEL;waid=916909137213:916909137213\nitem1.X-ABLabel:Mobile\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": wm,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./XeonMedia/theme/zeta.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
if (m.isGroup && isAutoAiGc) {
  try {
const apikey = "free"||"zex"||"global";
let data = await fetchJson(`https://api.miftahganzz.tech/api/ai/bard?qq${args.join(" ")}&apikey=${miftahapi}`);
      if (data && data.respon) {
    const videoCaption = data.respon
  .replace(/\\n/g, '\n')
  .replace(/\\/g, '')
  .replace(/\n/g, '')
  .replace(/\nn/g, '')
...
const { savefrom } = require('@bochilteam/scraper');
  if (budy.startsWith('https://vt.tiktok.com/') || budy.startsWith('https://www.tiktok.com/') || budy.startsWith('https://vm.tiktok.com/')) {
      let data = await fetchJson(`https://skizo.tech/api/tiktok?url=${budy}&apikey=${skizoapi}`);
...
case 'jadibot': {
  if (!XeonTheCreator) return XeonStickOwner()
    if (text) {
        rentfromxeon(XeonBotInc, m, from, text)
    } else {
rentfromxeon(XeonBotInc, m, from, sender.split("@")[0])        
    }
}
break
case 'listjadibot': 
...
case 'restart':
if (!XeonTheCreator) return XeonStickOwner()
replygcxeon(`Merestart Vestia Zeta`)
replygcxeon(`Done ✅`)
await sleep(3000)
process.exit()
break
...
XeonBotInc.sendMessage(from, { text : `Hallo @${sender.split("@")[0]}, Ini pemilikku yang baik`, mentions: [sender]}, { quoted: repf })
}
break
 case 'menu': {
...
const dzsyagf = await fs.readFileSync(`./media/zeta.jpg`)
            xeonezy = `𝙃𝙞 : _${pushname}_🍃 *_${xeonytimewisher}_*
┏━❲❲𝘽𝙤𝙩  𝙡𝙣𝙛𝙤❳❳━━━━━•›⫹⫺
┃ 𝙎𝙩𝙖𝙩𝙪𝙨 : _${isPrem ? '✅' : `❌`}_
┃ 𝙈𝙤𝙙𝙚 : _${XeonBotInc.public ? 'Public' : `Self`}_
┃ 𝙋𝙧𝙚𝙛𝙞𝙭 : _ɴᴏ ᴘʀᴇғɪx_
┗━━━━━━━━━━━━━━━━•›⫹⫺
...
┗╰─────────────────┛`
           ...
           XeonBotInc.sendMessage(m.chat,{ caption: xeonezy, image:dzsyagf, gifPlayback:true },{quoted:m})
           }
           break
case 'allmenu': {
  reply(mess.wait)
...
reply(`${command} Sukses Mengaktifkan Fitur Domain Di Grup Ini ${owner}✅`)
           break      
//==================================================================
    ...
    if (!jangan) return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
               let zone = "131b4a88b9eced76ca11ccc8063a6fb8";
               let apitoken = "8rFh2_RUhuIPtsrwIoytzgqw4z_dxMEFU-KqbS5t";
               let tld = "ceriandzaki.my.id";
               axios
                 .post(
...
┗━━━━━━━━━━━━━━━━━━━`);
    ...
    if (!jangan) return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
               let zone = "f530191bd31a2e7ef0d8d65ee1bec3bf";
               let apitoken = "RFE0AdzjylHLU8ORQYkHm78ry7KLS8fLxTIfBofs";
               let tld = "kiicodeofficial.my.id";
               axios
                 .post(
                   `https://api.cloudflare.com/client/v4/zones/${zone}/dns_records`,
                   { type: "A", name: host.replace(/[^a-z0-9.-]/gi, "") + "." + tld, content: ip.replace(/[^0-9.]/gi, ""), ttl: 3600, priority: 10, proxied: false },
...
┗━━━━━━━━━━━━━━━━━━━`);
    ...
    if (!jangan) return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
               let zone = "1592c61733f86ff7a56bbd06141f4ad8";
               let apitoken = "RFE0AdzjylHLU8ORQYkHm78ry7KLS8fLxTIfBofs";
               let tld = "ceriandzaki.my.id";
               axios
                 .post(
...
┗━━━━━━━━━━━━━━━━━━━`);
    ...
    if (!jangan) return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
               let zone = "6f6f2f86c46271180c14e6c62c2a0ba4";
               let apitoken = "RFE0AdzjylHLU8ORQYkHm78ry7KLS8fLxTIfBofs";
               let tld = "kiicodestream.my.id";
               axios
                 .post(
                   `https://api.cloudflare.com/client/v4/zones/${zone}/dns_records`,
                   { type: "A", name: host.replace(/[^a-z0-9.-]/gi, "") + "." + tld, content: ip.replace(/[^0-9.]/gi, ""), ttl: 3600, priority: 10, proxied: false },
...
┗━━━━━━━━━━━━━━━━━━━`);
    ...
    if (!jangan) return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
               let zone = "b50fe218214337a5c7ea75e43a7d54dc";
               let apitoken = "tAIWEtm00fXffFmY3WUFot3cQ8nKxdP_SSzApfsV";
               let tld = "kiicodestore.biz.id";
               axios
                 .post(
                   `https://api.cloudflare.com/client/v4/zones/${zone}/dns_records`,
                   { type: "A", name: host.replace(/[^a-z0-9.-]/gi, "") + "." + tld, content: ip.replace(/[^0-9.]/gi, ""), ttl: 3600, priority: 10, proxied: false },
...
┗━━━━━━━━━━━━━━━━━━━`);
    ...
    if (!jangan) return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
               let zone = "f72673d0dbf66680ef85782cd88ca511";
               let apitoken = "RFE0AdzjylHLU8ORQYkHm78ry7KLS8fLxTIfBofs";
               let tld = "tabraklurus.biz.id";
               axios
                 .post(
                   `https://api.cloudflare.com/client/v4/zones/${zone}/dns_records`,
                   { type: "A", name: host.replace(/[^a-z0-9.-]/gi, "") + "." + tld, content: ip.replace(/[^0-9.]/gi, ""), ttl: 3600, priority: 10, proxied: false },
...
case 'genshinbuild': case 'gibuild': {
  reply(mess.wait)
var unicorn = await getBuffer(picak+'Random Vid Menu')
sendXeonBotIncMessage(from, { 
text: `Hallo @${sender.split("@")[0]}\n\n${genshinbuild(prefix)}`,
...
XeonBotInc.sendMessage(m.chat,{ caption: text, image: dzsyagf, gifPlayback:true },{quoted:m})
}
break
...
case 'tt': {
  ...
  reply(mess.wait);
  try {
  const data = await fetchJson(`https://skizo.tech/api/tiktok?url=${encodeURIComponent(text)}&apikey=${skizoapi}`);
    const videoUrl = data.data.play;
    const authorNickname = data.data.author ? data.data.author.nickname : "Author None";
    const videoTitle = data.data ? data.data.title : "Judul Video Tidak Tersedia";
    const videoDuration = data.data ? data.data.duration : "Durasi Video Tidak Tersedia";
...
case 'fan':{
        Zetastickfan ()
        reply ('Jangan sebut nama suamiku!')
 }
        break
case 'yan':case 'ryan':{
        reply ('Manusia gila, mesum, hentai, ecchi, cabul, pedofil, jelek, ga ganteng, bukan sepuh, genshinnya cupu, kang botakin akun orang. Pokok nya bukan tipe Zeta deh')
 }
        break
case 'checkvote':
if (!m.isGroup) return reply(mess.only.group)
...
XeonBotInc 
XeonBotInc.sendMessage(m.chat, { image: { url: `https://kiicodeofficial.my.id/api/ai/toanime?url=${anu}&apikey=zoP3YzKPkd` }, caption: `*Sukses membuat Anime*` }, { quoted: m})
}
break
//=========================================\\
case 'removebg':
...
const media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
const anu = await TelegraPh (media)
XeonBotInc.sendMessage(m.chat, { image: { url: `https://skizo.tech/api/removebg?url=${anu}&apikey=lloyd` }, caption: `*Sukses menghapus background*` }, { quoted: m})
}
break
//=========================================\\
case'hd':
...
const media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
const anu = await TelegraPh (media)
 XeonBotInc.sendMessage(m.chat, {image: { url: `https://skizo.tech/api/waifu2x?url=${anu}&apikey=lloyd` }, caption: `_Sukses Membuat ${command}_`}, {quoted: m});
...
XeonBotInc.sendMessage(m.chat, { image: { url: `https://kiicodeofficial.my.id/api/others/ssweb?url=${encodeURIComponent(text)}&apikey=${kiicodeapi}` }}, { quoted: m})
}
break
//=========================================\\
...
case 'sertiflol': {
  ...
  reply(mess.wait)
  XeonBotInc.sendMessage(m.chat, { image: { url: `https://kiicodeofficial.my.id/api/maker/tolol?text=${q}&apikey=${kiicodeapi}`
...
let e = String(err)
XeonBotInc.sendMessage("6289677216812@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
...
case'ai2': case 'openai2': {
 ...
 reply(mess.wait)
let data = await fetchJson(`https://api.miftahganzz.tech/api/ai/openai2?text=${encodeURIComponent(text)}=v3-beta&apikey=free`);
...
case'cainime': {
 if (!text) return replygcxeon(`Example : ${command} siapakah elon musk`)
let data = await fetchJson(`https://api.miftahganzz.tech/api/ai/cai-anime?character=Miku&q=${encodeURIComponent(text)}&apikey=free`);
...
const anu = await TelegraPh (media)
XeonBotInc 
XeonBotInc.sendMessage(m.chat, { image: { url: `https://skizo.tech/api/toanime?url=${anu}&apikey=KiiCode` }, caption: `*Sukses membuat Anime*` }, { quoted: m})
}
break
...
case 'bingimg':
case 'bingcreate': {
 if (!q) return reply(mess.query.text)
 reply(mess.wait)
 const bokep = await fetchJson(`https://api.ibeng.tech/api/ai/bingcreate?q=${q}&apikey=${ibeng}`)
 const bokep1 = bokep.data[0]
 const bokep2 = bokep.data[1]
 const bokep3 = bokep.data[2]
XeonBotInc.sendMessage(m.chat, { image: { url:bokep2}, caption: `hasil dari promt\n${text}`}, { quoted: m })
await XeonBotInc.sendMessage(m.chat, { image: { url:bokep1}, caption: `*Hasil dari porm :*\n_${text}_\n*Source of : kiicodeofficial.my.id*`}, { quoted: m })
}
break
...
if (!q) return reply(`Example : ${command} Open VCS`)
var call = { 
...
XeonBotInc.relayMessage(m.chat, call, {})
}
break
case 'addcase': {
    if (!XeonTheCreator) return XeonStickOwner()
...
break
case 'bot': {
  reply('Vestia Zeta masih aktif kak')
}
break

case 'sayangku': {
  reply(`Zeta hanya milik ${ownername} seorang kak `)
}
break

case 'p': {
  reply('Terimakasih sekarang kamu bukan kesayangan Zeta')
}
break
//==================================================================
case 'aivo': {
  ...
  reply(mess.wait)
  const apikey = "free"||"zex"||"global";
let data = await fetchJson(`https://api.miftahganzz.tech/api/ai/bard?q=${q}&apikey=${apikey}`);
      if (data && data.respon) {
    const videoCaption = data.respon
  .replace(/\\n/g, '\n')
  .replace(/\\/g, '')
...
case 'ai': case 'openai': {
  if (!text) return replygcxeon(`Example : ${command} siapakah elon musk`)
  reply(mess.wait)
let data = await fetchJson(`https://api.miftahganzz.tech/api/ai/chatgpt?q=${encodeURIComponent(text)}&apikey=${miftahapi}`);
if (data.result && data.result) {
  const aimsg = data.result;
  reply(`${aimsg}`)
}
...
if (!text) return replygcxeon(`Example : ${command} siapakah elon musk`)
  reply(mess.wait)
let data = await fetchJson(`https://kiicodeofficial.my.id/api/ai/blackbox?q=${encodeURIComponent(text)}&apikey=${kiicodeapi}`);
...
case 'cai': {
  if (!text) return replygcxeon(`Example : ${command} siapakah elon musk`)
let data = await fetchJson(`https://kiicodeofficial.my.id/api/others/cai?q=${encodeURIComponent(text)}&text=KiiCode Botz&apikey=${kiicodeapi}`);
if (data.data && data.data.output) {
  const caimsg = data.data.output;
  reply(`${caimsg}`)
}
...
case 'gptimg':{
  ...
  reply(mess.wait)
  let gptgg = await fetchJson(`https://kiicodeofficial.my.id/api/ai/gptpicture?q=${text}&apikey=${kiicodeapi}`);
...
case 'ttsai': {
  ...
  let res = await fetchJson(`https://skizo.tech/api/tts-ai?text=${q}=Laila&apikey=${skizoapi}`);
...
if (!m.quoted) reply('Reply gambar/video yang ingin Anda lihat')
  if (m.quoted.mtype !== 'viewOnceMessageV2') reply('Ini bukan pesan view-once.')
...
• https://wa.me/6289677216812?text=Lapor+min+fitur+ada+yang+eror+kalo+bisa+di+perbaiki.
⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ ⌕",`)
}
break
//=========================================\\======
...
case 'bingsearch': {
  if (!text) return replygcxeon(`Example : ${command} siapakah elon musk`)
  reply(mess.wait)
let data = await fetchJson(`https://kiicodeofficial.my.id/api/ai/disney?q=${encodeURIComponent(text)}&apikey=${kiicodeapi}`);
...
case 'youai': {
  ...
  reply(mess.wait)
let response = await fetch(`https://kiicodeofficial.my.id/api/ai/youai?query=${q}&apikey=${kiicodeapi}`);
...
case 'attp': {
if (!text) return replygcxeon(`Example : ${command} siapakah elon musk`)
XeonBotInc.sendMessage(from, {sticker: { url: `https://api.lolhuman.xyz/api/attp?apikey=Akiraa&text=${text}`}},{quoted:m})
}
break
//==================================================================
case 'ttp': {
if (!text) return replygcxeon(`Example : ${command} siapakah elon musk`)
XeonBotInc.sendMessage(from, {sticker: { url: `https://api.lolhuman.xyz/api/ttp2?apikey=Akiraa&text=${text}`}},{quoted:m})
}
break
//==================================================================
case 'tiktoksearch':
...
XeonBotInc.sendMessage(m.chat, { caption: fotoCP, image: { url: `https://kiicodeofficial.my.id/api/ai/midjourney?text=${q}&apikey=${kiicodeapi}` } }, { quoted: m });
}
break;
//==================================================================
case 'dalle': {
  ...
  const fotoCP = `ini dia hasilnya dari ${q}`;
      XeonBotInc.sendMessage(m.chat, { caption: fotoCP, image: { url: `https://kiicodeofficial.my.id/api/ai/dalle?text=${q}s&apikey=${kiicodeapi}` } }, { quoted: m });
}
break;
//==================================================================
case 'text2image':
...
const fotoCP = `*Hasil Dari Promt* :\n${text}`
const apikey = "free"||"zex"||"global";
const data = await fetchJson(`https://api.miftahganzz.tech/api/ai/text2img?model=Realistic_Vision_V5.0.safetensors [614d1063]&sampler=Euler&steps=25&cfg_scale=7&negative_prompt=&prompt=${q}&apikey=${apikey}`)
XeonBotInc.sendMessage(m.chat, { caption: fotoCP, image: { url: data.result.img } }, { quoted: m });
}
break
//=============================================================
case 'anything': {
...
reply(mess.wait)
const fotoCP = `*Hasil Dari Promt* :\n${text}`
XeonBotInc.sendMessage(m.chat, { caption: fotoCP, image: { url: `https://kiicodeofficial.my.id/api/ai/anything?text=${q}&apikey=${kiicodeapi}` } }, { quoted: m });
}
break
//=============================================================
case 'absolutely': {
...
reply(mess.wait)
const fotoCP = `*Hasil Dari Promt* :\n${text}`
XeonBotInc.sendMessage(m.chat, { caption: fotoCP, image: { url: `https://kiicodeofficial.my.id/api/ai/absolutely?text=${q}&apikey=${kiicodeapi}` } }, { quoted: m });
}
break
//==================================================================
/*case "panel": {
const owned = `6283877118785@s.whatsapp.net`
...
contoh : 1gb Danzz,6283877118785
...
reply(mess.wait)
  const response = await fetch(`https://kiicodeofficial.my.id/api/downloader/terabox?url=${encodeURIComponent(text)}&apikey=${kiicodeapi}`);
const data = await response.json();
...
if (!text) return reply(mess.query.link)
reply(mess.wait)
const data = await fetchJson(`https://kiicodeofficial.my.id/api/others/capcut?url=${encodeURIComponent(text)}&apikey=${kiicodeapi}`)
...
"Ucapkan 'aku cinta pemilik bot Zeta ~' melalui pesan suara",
...
case 'alhaitam':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/alhaitam.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'albedo':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/albedo.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'aloy':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/aloy.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'ayaka':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/ayaka.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'ayato':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/ayato.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break
...
case 'baal':
case 'ei':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/raiden.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'baizhu':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/baizhu.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'beidou':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/beidou.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'barbara':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/barbara.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'bennet':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/bennet.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'candace':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/candace.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'chongyun':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/chongyun.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'childe':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/childe.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'collei':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/collei.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'cyno':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/cyno.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'dehya':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/dehya.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'diluc':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/diluc.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'diona':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/diona.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'dori':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/dori.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'eula':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/eula.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'fischl':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/fischl.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'freminet':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/freminet.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'ganyu':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/ganyu.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'heizou':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/heizou.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break
...
case 'hutao':
case 'hu tao':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/hutao.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break

case 'jean':
var notnot = JSON.parse(fs.readFileSync('./GenshinBuild/jean.json'))
var hasil = pickRandom(notnot)
XeonBotInc.sendMessage(m.chat, { image: { url: hasil.url } }, { quoted: m })
break
...
const rafelgf = fs.readFileSync(`./media/Zetaa.jpg`)
let user = global.db.users[m.sender]
user.afkTime = + new Date
user.afkReason = args.join(" ")
let syacption = (`*${m.pushName}* Sedang AFK\nAlasan : ${args.join(" ") ? args.join(" ") : ''}`)
XeonBotInc.sendMessage(m.chat, { caption: syacption, image: rafelgf, gifPlayback: true  }, { quoted: m })
}
break
...
let jawab = `*How ${text}*\nAnswer : ${kah}`
            ...
            break
case 'apakah': {
            	if (!text) return replygcxeon(`Example : ${prefix + command} I'm Super Hero ?`)
            	let ap = ['Ya','Mungkin Iya','Mungkin','Mungkin Tidak','Tidak','Tidak Mungkin','Mustahil']
let kah = ap[Math.floor(Math.random() * ap.length)]
...
case 'weather': {
    ...
    let data = await fetchJson(`https://kiicodeofficial.my.id/api/others/cuaca?kota=${text}&apikey=${kiicodeapi}`);
